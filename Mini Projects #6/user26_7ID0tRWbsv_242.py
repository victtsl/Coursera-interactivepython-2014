    ...
    def get_value(self):
        ...
        for y in val_list:
            if (y == 1 and (total_value + 11 <= 21)):
                total_value += y * 11
            elif (y == 1 and (total_value + 10 <= 21)):
                total_value += y * 10                
            else:
                total_value += y
...
def hit():
    ...
    #    if in_play:
        score -= 1
        in_play = False        
    #elif player_hands.get_value() = 21:
    print "SCORE1=", score    
...
def stand():
    ...
    print "Dealer Val=", dealer_hands.get_value()
    print "Player Val=", player_hands.get_value()
    #print "is_player_busted=", is_player_busted
...
def draw(canvas):
    ...
    #elif dealer_hands.get_value() > 21:
    #    dealer_busted_msg = "Dealer has busted!"
    #    player_busted_msg = "YOU WIN! New deal?"        
    #    if in_play:
    #        score += 1
    ...
    #elif dealer_hands.get_value() <= player_hands.get_value():
    #    dealer_busted_msg = "DEALER WINS!"
    #else:
    #    player_busted_msg = "YOU WIN!"
    ...
    canvas.draw_text(player_busted_msg, [200,320],30,"Red")    
    ...
    if in_play:
    #canvas.draw_image(card_back, [240, 180], CARD_BACK_SIZE, [CARD_BACK_CENTER[0], CARD_BACK_CENTER[1]], CARD_BACK_SIZE)
