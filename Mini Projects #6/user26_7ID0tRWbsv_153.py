...
def deal():
    global outcome, in_play, game_deck, player_hands, dealer_hands, busted_msg
...
# draw handler    
def draw(canvas):
    global player_hands, dealer_hands, busted_msg
    
    if player_hands.get_value() > 21:
        busted_msg = "You have busted!"
    ...
    canvas.draw_text(busted_msg, [150,320],30,"Red")    
    #card = Card("S", "A")
