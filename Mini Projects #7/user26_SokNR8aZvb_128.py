...
class Ship:
    ...
    def draw(self,canvas):
        #if is_thrusters true, draw image of ship with thrusters otherwise draw image of ship without thrusters
        if is_thrusters:      
    ...
    def shoot(self):
        global is_shoot, a_missile
        cannon_pos_offset = 40
        missile_vel_offset = 10
        cannon_pos = [0,0]
        missile_vel = [0,0]
        missile_vel[0] += self.vel[0] + move_forward[0] * missile_vel_offset
        missile_vel[1] += self.vel[1] + move_forward[1] * missile_vel_offset
        ##missile_vel = move_forward 
        ##missile_vel[0] *= missile_vel_offset
        ##missile_vel[1] *= missile_vel_offset
        ...
        #missile_vel[0] += self.vel[0] * missile_vel_offset
        #missile_vel[1] += self.vel[1] * missile_vel_offset
        #missile_vel[0] = self.vel[0] + missile_vel[0]  * missile_vel_offset
        #missile_vel[1] = self.vel[1] + missile_vel[0] * missile_vel_offset
        #print "Missile_vel=", missile_vel
...
#Initialization of Ship(pos, vel, angle, image, info):
